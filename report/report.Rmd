...
```{r results= 'asis', echo =FALSE}
tb_Newspaper <- xtable(regressionRadio, caption = 'Simple regression of sales on Newspaper')
...
```{r results= 'asis', echo =FALSE}
tb_corr <- xtable(corr_matrix, caption = 'Correlation Matrix of Advertising Data')
